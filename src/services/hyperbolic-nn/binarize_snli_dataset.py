...
parser.add_argument(
    "--root_path", type=str, help="Root path", default="/path/to/your/snli_dataset/"
)

# Original SNLI files.
parser.add_argument(
    "--train_file", type=str, help="Train path", default="snli_1.0/snli_1.0_train.txt"
)
...
CLASS_TO_ID = {"contradiction": 2, "neutral": 0, "entailment": 1}
...
def save_files():
    word_to_id, id_to_word = get_vocab(
        [original_filepath_train, original_filepath_dev, original_filepath_test]
    )
